...
class TagDaoImplTest {
    ...
    void create() {
        ...
        int id = 0;
        id = tagDao.create(expected).get().getId();
    ...
    void read() {
        ...
        Optional<Tag> optionalActual = tagDao.read(id.intValue());
    ...
    void readByCertificateId() {
        ...
        expected.forEach(tag -> insertCertificateTagDependency(certificateId, tag.getId()));

        actual = tagDao.readByCertificateId(certificateId);
    ...
    private Number insertAndReturnAutogeneratedId(Tag tag, JdbcTemplate template) {
        ...
        return certificateInsert.executeAndReturnKey(new TagParameterSource(tag));
    }
}